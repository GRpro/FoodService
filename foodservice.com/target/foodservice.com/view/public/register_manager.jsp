...
<div id="content">
    ...
    <div id="centralbar">
        ...
        <br>
        <form action="${root}/register/manager"  method="post" enctype="multipart/form-data">
            ...
            <p><input id="shopAdminUserEmail" name="shopAdminUserEmail" type="text" placeholder="Enter there shop admin email" required></p>
            ...
            <input id="submitManagerUserForm" type="submit" value="Sign up">
        </form>
    </div>
    <div id="rightbar">
    </div>
